...
| **AI 代读 + 播客** | 总结 + 朗读 | 小说集、论文集、读不完的大部头 |
...
| SKILL.md | ✅ 完成 | Skill 定义（参考 Anthropic Skills） |
| 参考文档 | ✅ 完成 | 6 个参考文件 |
...
| 播客功能 | ✅ 完成 | 场景 4: AI 代读 + 播客 |
| 重复内容清理 | ✅ 完成 | Samantha/Her 段落合并 |
| Skill 安装方式 | ✅ 完成 | 参考 Anthropic Skills 标准 |
