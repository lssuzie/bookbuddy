...
DESIGN_PRESETS = {
    ...
    "Her知性元气": {
        "voice": "温暖、知性、充满生命力的女声，30岁左右。声线略带沙哑质感，像清晨醒来时还没完全清醒但充满情绪的声音。嗓音不高亢，但有力量，听起来既温柔又坚定。像是你身边那个总是懂你、陪你、给你力量的人。",
        "style": "用极其自然、像在跟老朋友说话的语气朗读。声音充满感情，但不煽情。语速适中，在重要的词上可以稍微加重或放慢。偶尔带点微笑的语调，让人听了就感到安心和温暖。像是有人在耳边轻声细语地对你说'没事的，我在这里'。",
    },
}
