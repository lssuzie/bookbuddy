...
DESIGN_PRESETS = {
    ...
    "Her知性元气": {
        ...
        "style": "用极其自然、像在耳边私语的语气朗读。声音轻柔但有厚度，带着沙哑的质感。语速适中偏慢，偶尔带点随性的停顿和轻轻的呼吸声。不要朗读腔，不要播音感。声音要温暖亲切，带着一点慵懒的性感。像是她想到了什么，然后轻轻地说给你听，就像你们之间只有你们两个人。",
    },
    "悬疑小说": {
        "voice": "沉稳的男中音，35 岁左右，声线低沉而有磁性，像深夜讲故事的旁白。声音有厚度，带着一种神秘感，每个字都像是在制造悬念。",
        "style": "用低沉、缓慢、有节奏的语调朗读，像是在讲一个引人入胜的故事。在关键情节处稍作停顿，制造悬念感。语气沉稳但不呆板，带着一种神秘的氛围。字与字之间要有呼吸感，不要一口气念完。像是在炉火边给听众讲一个深夜故事。",
    },
}
...
模式示例:
  ...
  python generate_audio.py 书.md --voice-design "Her知性元气"  # 预设：略带沙哑的温暖女声，BookBuddy默认灵魂声线
