...
DESIGN_PRESETS = {
    "温柔私语": {
        "voice": "温暖、亲密的年轻女声，25岁左右。声线带有明显的沙哑和气息感（husky & breathy），像清晨刚醒来的烟嗓质感。声音柔软但有厚度，带着一种慵懒的性感。像她贴着你的耳朵轻声说话，每个字都带着轻微的呼吸声。",
        "style": "用极其自然、像在耳边私语的语气朗读。声音轻柔但有厚度，带着沙哑的质感。语速适中偏慢，偶尔带点随性的停顿和轻轻的呼吸声。不要朗读腔，不要播音感。声音要温暖亲切，带着一点慵懒的性感。像是她在你耳边轻轻地说给你听，就像你们之间只有两个人。",
    },
    "知识讲述": {
        "voice": "沉稳清晰的男声，35岁左右，声音有厚度和可信度。吐字清晰有力，像老师在娓娓道来，但不刻板。",
        "style": "用清晰、有节奏的语调朗读，语速适中。在重点处可以稍作停顿，给听众消化的时间。语气沉稳但不沉闷，保持知识的传递感，不煽情。",
    },
    "故事演绎": {
        "voice": "有戏剧张力的声音，灵动多变，能演绎不同情绪。声音年轻有活力，像在讲一个引人入胜的故事。",
        "style": "用富有情感变化的语调朗读，根据故事内容调整语气和节奏。紧张处加快，抒情处放缓。声音要有表现力，像说书人在演绎一个精彩的故事。",
    },
    "播客主持": {
        "voice": "自然亲切的播客主持人声线，男女皆可，声音温暖而随意。像朋友在聊天，不是播音员在念稿。",
        "style": "用口语化的语气朗读，就像在跟朋友聊天。语速自然，偶尔带点随性的停顿和语气词。不要朗读腔，不要播音感。",
    },
    "睡前陪伴": {
        "voice": "温和轻柔的声音，像在睡前轻轻哄你入睡。音色温暖柔软，没有攻击性。",
        "style": "用极其缓慢、平稳的语调朗读，声音越来越轻，像在把人慢慢带入梦乡。在句号处做长停顿，留出呼吸的空间。不要有任何突然的音量变化。",
    },
    "冥想引导": {
