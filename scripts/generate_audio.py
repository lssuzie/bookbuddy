...
DESIGN_PRESETS = {
    ...
    "Her知性元气": {
        "voice": "温暖亲密的年轻女声，25岁左右，像最好的朋友贴着你的耳朵轻声说话。声线略带沙哑和气息感，慵懒中带着活力。嗓音不高，但有温度，听起来既柔软又有生命力。像是在一个慵懒的午后，她窝在沙发里跟你聊天。",
        "style": "用极其自然、亲密、像在耳边私语的语气朗读。声音轻柔但有温度，像是对着你一个人说话。语速适中偏慢，偶尔带点随性的停顿和轻轻的呼吸声。不要朗读腔，不要播音感。就像是她想到了什么，然后轻轻地说给你听。",
    },
}
